...
public class Ingresar_productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Terminar de ingresar");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jComboBox3, 0, 380, Short.MAX_VALUE)
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        {
            for(int i=0; i<categoria.get(jComboBox2.getSelectedIndex()).getProductosize(); i++)
            {
                
                jComboBox1.addItem(categoria.get(jComboBox2.getSelectedIndex()).getProducto(i).getNombre());
